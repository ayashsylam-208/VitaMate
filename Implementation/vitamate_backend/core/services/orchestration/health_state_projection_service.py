    ...
    def build_projection(
        ...
        *,
        ...
        history_entry = {
            ...
            "sodium_mg": round(nutrition_totals.get("sodium_mg", 0), 2),
            "potassium_mg": round(nutrition_totals.get("potassium_mg", 0), 2),
            "calcium_mg": round(nutrition_totals.get("calcium_mg", 0), 2),
            "iron_mg": round(nutrition_totals.get("iron_mg", 0), 2),
            "magnesium_mg": round(nutrition_totals.get("magnesium_mg", 0), 2),
            "zinc_mg": round(nutrition_totals.get("zinc_mg", 0), 2),
            "phosphorus_mg": round(nutrition_totals.get("phosphorus_mg", 0), 2),
            "vitamin_a_mcg": round(nutrition_totals.get("vitamin_a_mcg", 0), 2),
            "vitamin_c_mg": round(nutrition_totals.get("vitamin_c_mg", 0), 2),
            "vitamin_d_mcg": round(nutrition_totals.get("vitamin_d_mcg", 0), 2),
            "vitamin_e_mg": round(nutrition_totals.get("vitamin_e_mg", 0), 2),
            "vitamin_k_mcg": round(nutrition_totals.get("vitamin_k_mcg", 0), 2),
            "vitamin_b1_mg": round(nutrition_totals.get("vitamin_b1_mg", 0), 2),
            "vitamin_b2_mg": round(nutrition_totals.get("vitamin_b2_mg", 0), 2),
            "vitamin_b3_mg": round(nutrition_totals.get("vitamin_b3_mg", 0), 2),
            "vitamin_b6_mg": round(nutrition_totals.get("vitamin_b6_mg", 0), 2),
            "vitamin_b12_mcg": round(nutrition_totals.get("vitamin_b12_mcg", 0), 2),
            "folate_mcg": round(nutrition_totals.get("folate_mcg", 0), 2),
            "caffeine_mg": round(nutrition_totals["caffeine_mg"], 2),
            "sleep_hours": round(sleep_hours, 2),
            "sleep_target": sleep_goal_hours,
            "exercise_minutes": exercise_minutes,
            "tracker_points_estimate": tracker_points_estimate,
            "medication_points": medication_points,
            "points_estimate": tracker_points_estimate + medication_points,
            "burn_target": burn_target,
